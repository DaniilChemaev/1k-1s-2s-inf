...
<div><img src="img21/black-bar.gif"><img src="img21/black-bar.gif"><img src="img21/black-bar.gif"><img src="img21/black-bar.gif"></div>
		...
		<a class="twitter-timeline" data-tweet-limit="3" href="https://twitter.com/worldsworstweb?ref_src=twsrc%5Etfw">Tweets by worldsworstweb</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
		</div>				<p>
			...
			<p>Hard hats required! This sight is...
...
<marquee scrollamount="40" direction="right">COVFEFE!!!!</marquee>
			</td>
		</tr>
</table>
...
border="0" alt="HTML Hit Counter"></a>
		  ...
		  <td style="background-color: #fff">	<img src="img21/con-1.gif"><br>					<h2 style="color: blue; text-shadow: 1px 1px #000; font-size: 250%; background-color: #fff; font-family: Brush Script MT, Brush Script, Times, Time New Roman, serif">---&gt;&gt;&gt; TWWWE Poll &lt;&lt;&lt;---</h2>
			  <p style="font-size: 200%; color: red;">Do you think this is really a  beautifully designed web sight?</p>
			  <p><img src="img21/terrible-poll.jpg" width="600" height="600" alt=""/></p>
</td>
		  <td><h2 style="color: blue; text-shadow: 1px 1px #000; font-size: 250%; background-color: #fff; font-family: Brush Script MT, Brush Script, Times, Time New Roman, serif"><img src="img21/new21.gif"> <img src="img21/new21.gif">NEW EDITIONS <img src="img21/new21.gif"> <img src="img21/new21.gif"></h2>
			<p style="background-color: white;"><span style="font-size: 400%; color: red">ELON MUSK BAUT TWITTER!!!!!!</span>  I'm so excited. AS promised, HERE is the MUSK HEAD right nex to my hot dog.</p>			<img src="img21/musk-dog.png" alt="ELON MUSK HOTDOG"/></td>
...
Your browser does not support the audio element.
	...
	<table style="border: 20px solid pink; width: 7000px;">
		<tr>
		  <td valign="top" style="border: 20px solid pink; background-color: aqua; width: 300px;"><h2 style="font-family: Comic Sans MS, Comic Sans, Times, Times New Roman, serif">The 9 ABSOLUTE BEST WEB SIGHTS on the WHOLE WWW</h2>
			  <ol>
				  <li>There</li>
				  <li>are</li>
				  <li>no</li>
			...
			<td valign="top" style="border: 20px solid pink; background-color: aqua; width: 300px;"><h2 style="font-family: Comic Sans MS, Comic Sans, Times, Times New Roman, serif">TWWWE Privacy &amp; Terms of Service &amp; Facebook Is The Matrix</h2>
				<ul style="font-family: Comic Sans MS, Comic Sans, Times, Times New Roman, serif">
					...
					<li>We do have Google services on the sight.  You're probably subject to their terms and privacy, whatever they are...</li>
					<li>TWWWE isn't liable for people being stupid on the internet...</li>
					<li>We aren't responsible for links from this sight...</li>
...
This sight was best viewed through <img src="img21/ie7.jpg"> Internet Explorer but they got rid of that, so probably <img src="img21/firefox-3.jpg"> Firefox.  View through at least a 1024x768 resolution - definately not with a smartphone.  lol.  Macs are still stupid and so is Safari so this sight prolly won't look right through Safari or an Apple.  We feel sorry for you Apple worshippers :(
	<br><br>
	&copy; 2008-2022 TWWWE.  All Rights Reserved.  So there!  Contact ----&gt; donot.email.us@twwwe.com
